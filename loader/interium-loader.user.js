...
// @version      2.0.0
// @description  CSP-safe loader: Tampermonkey attaches the Interium runtime from GitHub (via jsDelivr) using @require.
...
// @require      https://cdn.jsdelivr.net/gh/warmpain9/Interium@main/dist/interium-main-working-2.js
 ...
 *
 * How updates ship:
 * 1. Commit the new runtime to dist/interium-main-working-2.js on main.
 ...
 */
console.info('[Interium Loader] v2.0.0 - runtime attached via @require (CSP-safe).');
