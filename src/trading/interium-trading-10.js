...
const pgMtAnnotateSection = (sec, offer) => {
	...
	if(totalRow){
		...
		const v2=document.createElement('span'); v2.style.cssText='display:inline-flex;align-items:center;gap:6px;font-weight:700;color:#0084dd !important;';
		v2.innerHTML=PG_KOROMONS_SVG+'<span style="color:#0084dd !important;">'+(valKnown>0?mixedTotal.toLocaleString():rapTotal.toLocaleString())+'</span><span style="color:#0084dd !important;font-weight:500;opacity:.85;"> (+ unvalued)</span>';
		t2.appendChild(v2);
	}
	...
	panels.forEach((panel,i)=>{
		...
		if(totalRow){
			...
			if(vt2.getAttribute('data-pg-mix')!==mixTxt){
				...
				vt2.innerHTML='<span style="display:inline-flex;align-items:center;gap:6px;font-weight:700;color:#0084dd !important;">'+PG_KOROMONS_SVG+'<span style="color:#0084dd !important;">'+mixTxt+'</span><span style="color:#0084dd !important;font-weight:500;opacity:.85;"> (+ unvalued)</span></span>';
			}
		}
	});
};
